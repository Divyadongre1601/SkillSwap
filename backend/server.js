...
// 1. Define allowed origins to avoid trailing slash issues and local/prod conflicts
const allowedOrigins = [
    'http://localhost:5173',
    'https://skill-swap-pearl.vercel.app'
].filter(Boolean);
...
// 2. Apply the same origin array to Express CORS
app.use(cors({ 
    origin: allowedOrigins, 
    credentials: true 
}));
